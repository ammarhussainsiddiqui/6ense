      ...
      <div className="py-4">
        <div className="flex items-center justify-center textWhite">
          <div className="rounded-lg py-1 px-1 flex items-center flex-wrap justify-center bg-gray-300 gap-1">
            <div
              className={`flex items-center flex-nowrap gap-x-1.5 uppercase py-2 px-3 rounded-md cursor-pointer ${activate === "ETH" ? "bgBlue" : "bgBlack"
                }`}
            ...
            <div
              className={`flex items-center flex-nowrap gap-x-1.5 uppercase py-2 px-3 rounded-md bgBlack cursor-pointer ${activate === "USDT" ? "bgBlue" : "bgBlack"
                }`}
            ...
            <div
              className={`flex items-center flex-nowrap gap-x-1.5 uppercase py-2 px-3 rounded-md bgBlack cursor-pointer ${activate === "CARD" ? "bgBlue" : "bgBlack"
                }`}
            >
              <FaRegCreditCard />
              <WertComponent />
            ...
            <div
              className={`flex items-center flex-nowrap gap-x-1.5 uppercase py-2 px-3 rounded-md bgBlack cursor-pointer ${activate === "BANK TRANSFER" ? "bgBlue" : "bgBlack"
                }`}
